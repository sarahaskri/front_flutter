        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildWorkoutItem('Fullbody Workout', "assets/images/FBW.png",
                  ontap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>
                          WorkoutListPage(workoutType: 'Fullbody Workout'),
                    ));
              }),

              _buildWorkoutItem(
                'Upperbody Workout',
                "assets/images/UBW.png",
                ontap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>
                            WorkoutListPage(workoutType: 'Upperbody Workout'),
                      ));
                },
              ),
              if (showAllWorkouts) ...[
                _buildWorkoutItem('Lowerbody Workout', "assets/images/LBW.png",
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            WorkoutListPage(workoutType: 'Lowerbody Workout'),
                      ));
                }),
                _buildWorkoutItem(
                  'AB Workout',
                  ...
                  ontap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              WorkoutListPage(workoutType: 'AB Workout'),
                        ));
                  },
                ),
              ],
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => const FullWorkout(
                              ...
                              dObj: {
                                "exercise&time":
                                    "6 Exercises | 45mins", // Pass the subtitle value explicitly

                                "b_image":
                                    "assets/images/FBW.png", // Replace with the correct image path
                              },
                            ),
                          ));
                    },
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => const LowerBWorkout(
                              ...
                              dObj: {
                                "exercise&time":
                                    "6 Exercises | 32mins", // Pass the subtitle value explicitly

                                "b_image":
                                    "assets/images/LBW.png", // Replace with the correct image path
                              },
                            ),
                          ));
                    },
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => const ABworkout(
                              ...
                              dObj: {
                                "exercise&time":
                                    "6 Exercises | 40mins", // Pass the subtitle value explicitly

                                "b_image":
                                    "assets/images/ABW.png", // Replace with the correct image path
                              },
                            ),
                          ));
                    },
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => const UpperBW(
                              ...
                              dObj: {
                                "exercise&time":
                                    "6 Exercises | 25mins", // Pass the subtitle value explicitly

                                "b_image":
                                    "assets/images/UBW.png", // Replace with the correct image path
                              },
                            ),
                          ));
                    },
