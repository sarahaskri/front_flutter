...
import 'package:fityes/sprint_2/Dinner/mealCategoryforDinner.dart'; // <-- Import du fichier ci‑dessus

class CategoryMealListDinner extends StatelessWidget {
  final Map mObj;
  final Map dObj;

  const CategoryMealListDinner({
    super.key,
    required this.dObj,
    required this.mObj,
  });
  ...
  Widget build(BuildContext context) {
    final meals = getMealsByCategoryForDinner(dObj['name']);
  ...
  Widget _buildMealCard({
    ...
    required MealExampleForDinner meal,
  }) {
    return Card(
      elevation: 4,
