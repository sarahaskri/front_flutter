...
class FoodInfoDetailsViewREC1 extends StatefulWidget {
  final Map mObj;
  final Map dObj;
  const FoodInfoDetailsViewREC1(
      {super.key, required this.dObj, required this.mObj});

  @override
  State<FoodInfoDetailsViewREC1> createState() => _FoodInfoDetailsViewStateREC1();
}

class _FoodInfoDetailsViewStateREC1 extends State<FoodInfoDetailsViewREC1> {
  List nutritionArr = [
